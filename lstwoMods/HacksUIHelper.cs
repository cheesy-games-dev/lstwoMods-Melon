...
namespace lstwoMODS_Core
{
    public class HacksUIHelper
    {
        ...
        private static MelonPreferences_Entry<string> configTheme;
        private static MelonPreferences_Entry<string> configButtonColor;
        private static MelonPreferences_Entry<string> configButtonColor2;
        private static MelonPreferences_Entry<string> configButtonColor4;
        private static MelonPreferences_Entry<string> configBGColor1;
        private static MelonPreferences_Entry<string> configBGColor2;
        private static MelonPreferences_Entry<string> configTabMenuBG;
        private static MelonPreferences_Entry<string> configHacksMenuBG;
        ...
        {
            RoundedRect ??= Core.AssetBundle.LoadAsset<Sprite>("RoundedRect");
            interFont ??= Core.AssetBundle.LoadAsset<Font>("Inter");
        }
        ...
        public static void LoadConfig()
        {
            ...
            configTheme = Core.PrefsCategory.CreateEntry("Theme", "original", "Theme", "The theme to use for lstwoMODS.\nAvailable themes: original.\nUse custom for custom colors defined in Theme.Custom category.");

            configButtonColor = Core.PrefsCategory.CreateEntry("Theme.Custom", "#38404F", "Button Color 1",  "Custom hex color for regular buttons.");
            configButtonColor2 = Core.PrefsCategory.CreateEntry("Theme.Custom", "#101821", "Button Color 2", "Custom hex color for tab buttons.");
            configButtonColor4 = Core.PrefsCategory.CreateEntry("Theme.Custom", "#26618c", "Button Color 3", "Custom hex color for special buttons.");

            configBGColor1 = Core.PrefsCategory.CreateEntry("Theme.Custom", "#21252d", "BG Color 1",  "Custom hex color for mod background color 1.");
            configBGColor2 = Core.PrefsCategory.CreateEntry("Theme.Custom", "#1d2129", "BG Color 2",  "Custom hex color for mod background color 2.");

            configTabMenuBG = Core.PrefsCategory.CreateEntry("Theme.Custom", "#1a2837", "Tab Menu BG Color",  "Custom hex color for tab menu background.");
            configHacksMenuBG = Core.PrefsCategory.CreateEntry("Theme.Custom", "#181b22", "Mod Menu BG Color",  "Custom hex color for mod menu background.");
