...
namespace lstwoMODS_Core.UI.TabMenus
{
    public abstract class BaseTab
    {
        ...
        public virtual void SetTabActive(bool active)
        {
            ...
            if(active)
            {
                Core.MainPanel.CurrentTab = this;

                if (Core.MainPanel.oldTab != null && Core.MainPanel.oldTab != this)
                    Core.MainPanel.oldTab.SetTabActive(false);

                Core.MainPanel.oldTab = this;
