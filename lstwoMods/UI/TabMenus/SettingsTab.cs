    ...
    public class SettingsTab : BaseTab
    {
        public float UISize
        {
            ...
            set
            {
                ...
                var transform = Core.MainPanel.ContentRoot.transform;
        ...
        private MelonPreferences_Entry<float> configUISize;
        ...
        public override void ConstructUI(GameObject root)
        {
            ...
            configUISize = Core.PrefsCategory.CreateEntry("Settings", 1f, "UISize");
